...
app = Flask(__name__)
## origins => sirve para idnciar que domios pueden acceder a mi API, x defecto su valor es '*' que permitirá acceder a todos los origenes

CORS(app=app, origins='*', methods=['GET', 'POST'], allow_headers='Content-type')
